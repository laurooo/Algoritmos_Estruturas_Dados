    ...
    def escolher_e_remover(self):
        ...
        while True:
            ...
            if numero < 1 or numero > self.tamanho:
                print(f'Número inválido. Escolha entre 1 e {self.tamanho}.')
                continue
...
playlist.adicionar(Musica("Stairway to Heaven", "Led Zeppelin", 482))
playlist.adicionar(Musica("Bohemian Rhapsody", "Queen", 354))
playlist.adicionar(Musica("Hotel California", "Eagles", 391))
playlist.adicionar(Musica("Comfortably Numb", "Pink Floyd", 382))
playlist.adicionar(Musica("Africa", "Toto", 295))
